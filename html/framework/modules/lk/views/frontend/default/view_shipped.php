                ...
                <div class="col-xs-12">
                    <div class="white-block white-block--wide pd-top-55 pd-bottom-50 mr-bottom-20">
                        <ul class="create-steps">
                            ...
                            <li><i class="icon-ok"></i> Создан</li>
                            ...
                            <li class="active"><i class="icon-car"></i> Отгружен</li>
                        </ul>
                        <div class="create-steps__head">
                            ...
                            <div class="date"><span>Дата создания заказа:</span> <?= Yii::$app->formatter->asDate($order['createdAtDate'],
                                    'short') ?></div>
                        </div>
                        <ul class="create-steps__order-info border-bottom border-top">
                            <li>
                        ...
                        <div class="li">
                            <div class="ok-steps__info-bottom">
                                <div class="left">
                                    <span class="status-order shipped"><i class="icon-car"></i> Отгружен</span>
                                ...
                                <span class="show-lk-doc btn btn-primary order-btn-one-size"><i class="icon-doc"></i>Документы заказа</span>
                            </div>
                                    ...
                                    <li class="lk-list__head">
                                        <div class="li-inner">
                                            <div class="art active">
                                                Артикул
                                                <div class="sort"><span class="up active"></span><span class="down"></span></div>
                                            </div>
                                            <div class="brand active">
                                                Бренд
                                                <div class="sort"><span class="up"></span><span class="down active"></span></div>
                                            </div>
                                            <div class="name">
                                                Наименование товара
                                                <div class="sort"><span class="up"></span><span class="down"></span></div>
                                            </div>
                                            <div class="price">
                                                Цена
                                                <div class="tolltip-link" data-delay="500" data-toggle="tooltip" data-placement="top" title="Текст подсказки">
