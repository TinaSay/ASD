 ...
 * Class searchPager
 *
 * @package app\modules\search\widgets
 */
class SearchPager extends LinkPager
{
    /**
     * @return string
     */
    ...
    public function tplPager()
    {
        ...
        echo '<div class="container pd-bottom-90"><div class="row"><div class="col-xs-12"><div class="wrap-pagination">'
