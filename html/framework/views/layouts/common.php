...
<?php $this->beginPage() ?>
<!DOCTYPE html>
<html lang="<?= Yii::$app->language ?>" prefix="http://ogp.me/ns#">
<head>
...
<body id="cbp-so-scroller"
      class="<?= isset($this->params['bodyCssClass']) ? ' ' . $this->params['bodyCssClass'] : '' ?> anim-load">
<?php $this->beginBody() ?>
...
<!-- modal -->
<div id="modal-ctrl-enter"
     class="modal fade blue-bg"
     role="dialog">
